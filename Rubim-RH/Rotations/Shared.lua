...
function RubimRH.Shared()
   ...
   -- Start attack if we find a target in 40yards
	...
	if Player:AffectingCombat() then
        ...
        if Item(Healthstone):IsReady() and IsInRaid() 
        -- and ValidUnits >= 15 
        and Player:HealthPercentage() <= RubimRH.db.profile.mainOption.healthstoneper then
            return 538745
        end
            ...
            for i = 1, #RubimRH.db.profile.mainOption.useTrinkets do
                if RubimRH.db.profile.mainOption.useTrinkets[1] == true then
                    if trinketReady(1) then
                        return 0, "Interface\\Addons\\Rubim-RH\\Media\\TRINKET1.tga"
                    end
                end

                if RubimRH.db.profile.mainOption.useTrinkets[2] == true then
                    if trinketReady(2) then
                        return 0, "Interface\\Addons\\Rubim-RH\\Media\\TRINKET2.tga"
                    end
                end
            end
        end
